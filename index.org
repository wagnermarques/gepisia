#+TITLE: Síntese (Roteiro) dos Assuntos da Apresentação sobre IA (GEPIS)
...
+ IA para Ciência - Pesquisas em Periódicos
  
  Ferramentas de pesquisa em perídicos que que não só localizam
  artigos por palavras chaves em cada cada um deles, mas estas apresentadas aqui leem os textos para obter informações que agregam valor aos resultados da pesquisa.



* IA para ciência - Pesquisas em Periódicos

** Resumo das Ferramentas de IA para pesquisa
...
+ Como funciona a Ia nesta ferramenta?
  
  A sintaxe de pesquisa é construída por meio de linguagem natural  

*** Ferramenta sicencedirect-LeapSpace da Elsevier

   + Resumo
     
     Um chat de IA, mas as respostas provêm de artigos com as devidas citações
